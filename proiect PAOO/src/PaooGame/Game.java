...
import PaooGame.inputs.Key_Handler;
...
public class Game implements Runnable
{
    ...
    ///                 ****************          *****************        ***************
    ///                 *              *   Show   *               *        *             *
    /// [ Ecran ] <---- * Front Buffer *  <------ * Middle Buffer * <----- * Back Bu    ffer * <---- Draw()
    ///                 *              *          *               *        *             *
    ///                 ****************          *****************        ***************
    ...
    {
        wnd = new GameWindow("Schelet Proiect PAOO", 1000, 600);


        /// Este construita fereastra grafica.
        /// Se incarca toate elementele grafice (dale)

        Key_Handler keyHandler=new Key_Handler();
    ...
    private void Update()
    {
        //this.wnd.GetCanvas().addKeyListener(new Key_Handler());
        //player.update();
    }
    ...
    private void Draw()
    {
        ...
        g.clearRect(0, 0, wnd.GetWndWidth(), wnd.GetWndHeight());
            ...
            //this.player.getSprite().drawImage();

            //g.drawImage(this.player.getSprite(),player.getX(), player.getY(),null);
